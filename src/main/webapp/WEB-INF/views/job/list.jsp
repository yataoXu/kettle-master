...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	...
            	<div class="right">	
            	<button onclick="shrinklog()" class="btn btn-w-m btn-info" type="button">
                ...
                <table id="jobList" data-toggle="table"
					...
					<thead>
						<tr>
							...
							<th data-field="jobQuartz"
								data-formatter="jobQuartzFormatter">执行策略</th>
							<th data-field="jobLogLevel"
								data-formatter="jobLogLevelFormatter">日志级别</th>
    ...
    <script>
    	...
    	function jobLogLevelFormatter(value, row, index){             
            if (value == "basic"){
    			return "基本日志";
	    ...
	    function actionFormatter(value, row, index) {
	    	if (row.jobStatus == "1"){
	    		return [
	    			'<a class="btn btn-primary btn-xs" id="stop" type="button"><i class="fa fa-stop" aria-hidden="true"></i>&nbsp;停止</a>',
		    			'&nbsp;&nbsp;',
	    ...
	    window.actionEvents = {	    		
	    		...
	    		'click #edit' : function(e, value, row, index) {
	    			...
	    			var quartzId = row.jobQuartz;
	    			location.href = "view/cron/editUI.shtml?quartzId="  + quartzId+"&currentPage="+"view/job/listUI.shtml";
	    		},
		    ...
		    function shrinklog(){
		        $.ajax({
			        type: 'POST',
			        async: true,
			        url: 'job/monitor/maintain.shtml',
			        data: {},
			        success: function (data) {
			        	layer.msg('操作成功',{
	            			time: 2000,

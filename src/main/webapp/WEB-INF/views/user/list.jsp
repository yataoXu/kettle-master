	...
	<script>
	    function actionFormatter(value, row, index) {
	    	return ['<a class="btn btn-primary btn-xs" id="edit" type="button"><i class="fa fa-paste" aria-hidden="true"></i>&nbsp;编辑</a>',
    			...
    			'&nbsp;&nbsp;',
    			'<a class="btn btn-primary btn-xs" id="updatePwd" type="button"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;修改密码</a>',
    			'&nbsp;&nbsp;',
    			'<a class="btn btn-primary btn-xs" id="resetPwd" type="button"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;重置密码</a>'].join('');	
	    };
	    window.actionEvents = {				
	    		...
	    		'click #updatePwd' : function(e, value, row, index) {
	    			var uId = row.uId;
	    			location.href = "view/user/editPwdUI.shtml?uId=" + uId;
	    		},

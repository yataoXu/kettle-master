...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="userEditPwdForm">        
            	    <input type="hidden" name="uId" id="uId" value="${uId }">       
	                   
	                    <div class="form-group">
	                    <label class="col-sm-3 control-label">原密码：</label>
	                    <div class="col-sm-7">
							<input id="oPassword" name="oPassword" type="password" class="form-control" aria-required="true">
	                    </div>
	                </div>     
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">新密码：</label>
	                    <div class="col-sm-7">
							<input id="uPassword" name="uPassword" type="password" class="form-control" aria-required="true">
	                    </div>
	                </div>     
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">重复输入密码：</label>
	                    <div class="col-sm-7">
							<input id="vPassword" name="vPassword" type="password" class="form-control" aria-required="true">
	                    </div>
	                </div>         
	...
	<script src="static/js/my/user-editPwd.js"></script>   
</body>
</html>
...
<body class="gray-bg">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<div class="col-sm-6 float-left">	
	            	<a href="view/cron/AddUI.shtml" class="btn btn-w-m btn-info" type="button">
                ...
                <table id="quartzList" data-toggle="table"
					...
					<thead>
						<tr>				 
							<th data-field="quartzId">编号</th>
							<th data-field="quartzDescription">策略名称</th>
							<th data-field="quartzCron">策略</th> 
    ...
    window.actionEvents = {	    		
    		...
    		'click #edit' : function(e, value, row, index) {
    			...
    			location.href = "view/cron/editUI.shtml?quartzId=" + quartzId;
    		},

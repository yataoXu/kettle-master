    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	...
            	<input  readonly type='hidden' name="prepage" id="prepage" type="text"  class="form-control" aria-required="true" value="${prepage}">
            	
            	<div class="form-group">
	                    <label class="col-sm-3 control-label">策略ID：</label>
	                    <div class="col-sm-7">
	                        <input  readonly name="quartzId" id="quartzId" type="text"  class="form-control" aria-required="true" value="${quartzId}">
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-7">
	                        <input id="quartzCron" readonly name="quartzCron" type="text"  class="form-control" aria-required="true">
	                    </div>
	                </div>	             
	                ...
	                <div class="form-group">
	                       <div id="custom" style="display:block">
		                    ...
		                    <div class="col-sm-5">
		                        <input id="customerQuarz" readonly name="customerQuarz"   class="form-control" aria-required="true">
		                    </div>
	                	</div>	 
	                   </div>	   

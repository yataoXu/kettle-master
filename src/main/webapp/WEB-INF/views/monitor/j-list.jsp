		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<table id="jobMonitorList" data-toggle="table"
					data-url="job/monitor/getList.shtml" data-query-params=queryParams
					...
					<thead>
						<tr>
							...
							<th data-field="monitorJob">作业id</th>
	...
	<script>
	    ...
	    window.actionEvents = {				
    		'click #viewDetail' : function(e, value, row, index) {    			
    			...
    			//alert("view/job/record/listUI.shtml?jobId=" + row.monitorJob);
    			...
    			$.ajax({
    		        type: 'POST',
    		        async: false,
    		        url: 'job/monitor/resetCount.shtml',

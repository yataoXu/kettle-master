...
public class PageController {
	...
	@RequestMapping("user/editPwdUI.shtml")
	public String userEditPwdUI(Integer uId, Model model) {
		model.addAttribute("uId", uId);
		return "user/editPwd";
	}
	...
	@RequestMapping("cron/listUI.shtml")
	public String cronListUI() {
		return "cron/list";
	}

	@RequestMapping("cron/AddUI.shtml")
	public String cronRAddUI() {
		return "cron/add";
	}

	@RequestMapping("cron/editUI.shtml")
	public String cronEditUI(Integer quartzId,String currentPage, Model model) {
		model.addAttribute("quartzId", quartzId);
		model.addAttribute("prepage", currentPage);
		return "cron/edit";
	}
